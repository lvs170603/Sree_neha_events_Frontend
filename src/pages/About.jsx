...
import { CalendarHeart, Star, Users, Award, MapPin, Phone, Mail, Heart, Camera, Music, Utensils, Sparkles, Info } from 'lucide-react';
...
const About = () => {
    ...
    return (
        /* pt-28 md:pt-36 pushes content below fixed navbar */
        <div className="bg-gray-50 min-h-screen">

            {/* Hero Section — extra top padding to clear fixed navbar */}
            <section className="relative overflow-hidden bg-gradient-to-br from-purple-700 via-purple-600 to-pink-600 text-white pt-40 pb-24 px-4">
                <div
            ...
            {/* Stats — float up slightly from hero */}
            <section className="container mx-auto max-w-5xl px-4 -mt-10 relative z-10">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {stats.map((stat, i) => (
                        <motion.div key={i} variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} custom={i * 0.1}
                            ...
                            <div className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-gradient-to-br from-purple-100 to-pink-100 text-purple-600 mb-3 mx-auto">
                                {stat.icon}
                            </div>
            ...
            <section className="container mx-auto max-w-5xl px-4 py-20">
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
                        ...
                        <p className="text-gray-600 leading-relaxed mb-4">
                            Our journey began with a passion for bringing smiles to people's faces on their most important days. Today, we bring that same passion to every birthday party, wedding ceremony, and cultural celebration we undertake.
                        </p>
                    ...
                    {/* Mission/Vision card — no negative positioning to avoid z-index bugs */}
            ...
            <section className="bg-white py-20 px-4">
                <div className="container mx-auto max-w-5xl">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                        {services.map((s, i) => (
                            <motion.div key={i} variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} custom={i * 0.1}
                                className="p-6 rounded-2xl border border-gray-100 hover:border-purple-200 hover:shadow-lg transition-all group cursor-default text-center">
                                <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-br from-purple-100 to-pink-100 text-purple-600 mb-4 mx-auto group-hover:scale-110 transition-transform">
                                    {s.icon}
                                </div>
            ...
            <section className="container mx-auto max-w-5xl px-4 py-20">
                <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}
                    ...
                    <p className="text-gray-500 max-w-xl mx-auto">Here's what makes Sree Neha Events truly special.</p>
                </motion.div>
                    ...
                    <div className="flex flex-wrap justify-center gap-8">
                        {team.map((member, i) => (
                            <motion.div key={i} variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} custom={i * 0.15}
                                className="bg-white rounded-2xl p-8 shadow-md text-center w-56 hover:shadow-xl transition-shadow">
            ...
            <section className="container mx-auto max-w-4xl px-4 py-20">
                <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}
                    className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-3xl p-10 md:p-14 text-white text-center shadow-2xl">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                        <a href="tel:+919014444665"
                            className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-purple-700 font-bold rounded-full hover:shadow-lg transition-all hover:-translate-y-0.5 w-full sm:w-auto">
                            <Phone size={18} /> +91 9014444665
                        </a>
                        <a href="mailto:srinehaevents@gmail.com"
                            className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white/20 backdrop-blur text-white font-bold rounded-full border-2 border-white/40 hover:bg-white/30 transition-all hover:-translate-y-0.5 w-full sm:w-auto">
